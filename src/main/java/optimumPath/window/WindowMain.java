...
public class WindowMain extends JFrame {
	...
	private void initComponents() {
		...
		gl_panelMap.setHorizontalGroup(gl_panelMap.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelMap.createSequentialGroup().addGap(20)
						.addGroup(gl_panelMap.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelMap.createSequentialGroup().addComponent(lblWarstwa).addGap(18)
										.addComponent(spnLayer, GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE))
								.addComponent(rdbtnMapMod).addComponent(rdbtnPreview))
						.addContainerGap()));
		gl_panelMap.setVerticalGroup(gl_panelMap.createParallelGroup(Alignment.TRAILING).addGroup(gl_panelMap
				.createSequentialGroup().addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addComponent(rdbtnPreview).addPreferredGap(ComponentPlacement.UNRELATED).addComponent(rdbtnMapMod)
				.addGap(18)
				.addGroup(gl_panelMap.createParallelGroup(Alignment.LEADING).addComponent(lblWarstwa).addComponent(
						spnLayer, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
				.addContainerGap()));
		...
		panelAlg.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Algorytmy",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 0)));
		panelAlg.setToolTipText("");
		panelOptions.add(panelAlg);

		String[] algorithmsOptions = { "Propagacja Fali", "A Star", "Algorytm Genetyczny", "Algorytm Genetyczny zoptymalizowany" };
		...
		gl_panelAlg.setHorizontalGroup(gl_panelAlg.createParallelGroup(Alignment.LEADING).addGroup(gl_panelAlg
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panelAlg.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_panelAlg.createSequentialGroup().addComponent(lblWybrAlgorytmu).addGap(78))
						.addGroup(gl_panelAlg.createSequentialGroup().addComponent(lblWybrMetryki).addContainerGap(119,
								Short.MAX_VALUE))
						.addGroup(Alignment.TRAILING, gl_panelAlg.createSequentialGroup()
								...
								.addContainerGap()))));
		gl_panelAlg.setVerticalGroup(gl_panelAlg.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelAlg.createSequentialGroup().addContainerGap().addComponent(lblWybrAlgorytmu)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(cbAlgorithm, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18).addComponent(lblWybrMetryki).addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(cbMetrics, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
		...
		panelSafe.setBorder(new TitledBorder(null, "Strefa bezpiecze\u0144stwa", TitledBorder.LEADING, TitledBorder.TOP,
				null, null));
		...
		gl_panelSafe.setHorizontalGroup(gl_panelSafe.createParallelGroup(Alignment.LEADING).addGroup(gl_panelSafe
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panelSafe.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panelSafe.createSequentialGroup().addComponent(lblWielkoStrefy)
								.addPreferredGap(ComponentPlacement.RELATED, 25, Short.MAX_VALUE)
								.addComponent(spnThick, GroupLayout.PREFERRED_SIZE, 91, GroupLayout.PREFERRED_SIZE)))
				.addContainerGap()));
		gl_panelSafe.setVerticalGroup(gl_panelSafe.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelSafe.createSequentialGroup().addContainerGap().addComponent(lblZone)
						.addPreferredGap(ComponentPlacement.RELATED)
						.addComponent(cbZoneProhibited, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.UNRELATED)
						.addGroup(gl_panelSafe.createParallelGroup(Alignment.BASELINE).addComponent(lblWielkoStrefy)
								.addComponent(spnThick, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
										GroupLayout.PREFERRED_SIZE))
		...
		gl_panelAnim.setHorizontalGroup(gl_panelAnim.createParallelGroup(Alignment.LEADING).addGroup(gl_panelAnim
				.createSequentialGroup().addContainerGap()
				.addGroup(gl_panelAnim.createParallelGroup(Alignment.LEADING).addComponent(btnApply, Alignment.TRAILING)
						.addComponent(sliderAnimSpeed, Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, 207,
								Short.MAX_VALUE)
						.addComponent(lblSzybko).addComponent(cboxAnimation))
				.addContainerGap()));
		gl_panelAnim.setVerticalGroup(gl_panelAnim.createParallelGroup(Alignment.LEADING).addGroup(gl_panelAnim
				.createSequentialGroup().addGap(8).addComponent(cboxAnimation)
				.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblSzybko)
				.addPreferredGap(ComponentPlacement.UNRELATED)
				.addComponent(sliderAnimSpeed, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
				.addGap(18).addComponent(btnApply).addGap(53)));
		...
		btnSavePath.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if (render.getRenderMap().getPathShift().isEmpty() || render.getRenderMap().getAlgorithm() == null) {
					JOptionPane.showMessageDialog(null, "Scie¿ka nie istnieje na mapie.", "Zapis œcie¿ki",
		...
		btnApply.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				case 1:
					...
					break;
				case 2:
					render.getRenderMap().performGenteticAlgorithm(isChebyshev, zoneProhibited, thick, false);
					render.setAStar(false);
					break;
				case 3:
					render.getRenderMap().performGenteticAlgorithm(isChebyshev, zoneProhibited, thick, true);
					render.setAStar(false);
					break;
				}
